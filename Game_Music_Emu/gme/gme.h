...
/* Use in place of sample sampling_rate for open/load if you only need to get track
...
/* Creates new emulator and sets sample sampling_rate. Returns NULL if out of memory. If you only need
